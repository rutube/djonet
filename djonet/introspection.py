...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    ...
    def _name_to_index(self, cursor, table_name):
        ...
        return dict([(d[0], i) for i, d in
                     enumerate(self.get_table_description(cursor, table_name))]
                    )
    ...
    def get_indexes(self, cursor, table_name):
        ...
        cols = [col[0] for col in self.get_table_description(cursor,
                                                             table_name)]
        props = dict([(col, {'primary_key': False, 'unique': False}) for col
                      in cols])
